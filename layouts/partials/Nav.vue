    ...
    <div class="flex justify-between h-24">
      <div class="flex">
        <div class="-ml-2 mr-2 flex items-center md:hidden">
          ...
          <button type="button" @click="toggleButton();" class="mobile-menu-button inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-800 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" aria-controls="mobile-menu" aria-expanded="false">
            ...
            -->
            <svg class="block h-6 w-6 closed-button" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
            ...
            -->
            <svg class="hidden h-6 w-6 opened-button" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
      ...
      <div class="hidden  md:flex items-center">
        <div class="flex-shrink-0">
          <a href="mailto:greenflora2021@gmail.com" class="relative inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-gf-main  shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
