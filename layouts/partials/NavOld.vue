<template>
   <nav class="flex justify-between items-center shadow-lg w-full ">

        <div class="px-4 py-2 sm:px-8 flex justify-between">
            <div>
        ...
        <div class="self-center p-4 hidden md:block">
            <a href="mailto:greenflora2021@gmail.com"
                class="inline-block bg-gf-main py-3 px-6 rounded-full text-white font-sans font-bold">Book Now</a>
        </div>
    </nav>
