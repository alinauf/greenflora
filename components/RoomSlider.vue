...
<div class="container mx-auto">
  ...
  <div class="carousel w-full relative shadow-2xl mx-auto">
    <div class="carousel-inner relative overflow-hidden w-full">
      
      <!--Slide 1-->
      <input class="carousel-open" type="radio" id="carousel-1" name="carousel" aria-hidden="true" hidden="" checked="checked">
      <div class="carousel-item absolute opacity-0 max-h-screen" >
        <div class="block h-full min-w-full w-full bg-yellow-500 text-white text-5xl text-center">

        <img :src="`./rooms/room-1.jpg`" class="object-cover" />
      ...
      <div class="carousel-item absolute opacity-0 max-h-screen" >
        <div class="block h-full w-full bg-yellow-500 text-white text-5xl text-center">
                  <img :src="`./rooms/room-4.jpg`" class="object-cover" />
        </div>
      </div>
      ...
      <div class="carousel-item absolute opacity-0 max-h-screen" >
        <div class="block h-full w-full bg-yellow-500 text-white text-5xl text-center">
                  <img :src="`./rooms/room-5.jpg`" class="object-cover" />
